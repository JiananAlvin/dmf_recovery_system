...
namespace UnitTest
{
    public class ProcessTest
    {
        ...
        {
            // run YoloV5
            Thread myNewThread = new Thread(() => TestUtil.RunYoloV5InPython(PYTHON_COMMAND, PATH_TO_PY_SCRIPT, PATH_TO_WEIGHT, PATH_TO_CASE_SOURCE_ROOT, "Case0\\Source"));
            myNewThread.Start();
        ...
        public void TestCorrect1()
        {
            ...
            string expectedRecoveryOutput = "List of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   head: [ 326 327 328 ]   tail: [ 422 423 424 ]   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\n".Replace("\r", "").Replace("\n", "");
            string recoveryResult = File.ReadAllText(@"..\..\..\..\Cases\Case1\recovery_result.txt").Replace("\r", "").Replace("\n", "");
            Assert.That(recoveryResult, Is.EqualTo(expectedRecoveryOutput));

            string expectedBasmOutput = "[init]:shv 1 280\r\n[init]:hvpoe 1 1\r\n[init]:clra 0\r\n[init]:clra 1\r\n[step0]:setel 1 65\r\n[step1]:setel 1 66\r\n[step2]:clrel 1 65\r\n[step3]:setel 1 67\r\n[step4]:clrel 1 66\r\n[step5]:setel 1 68\r\n[step6]:clrel 1 67\r\n[step7]:setel 1 69\r\n[step8]:clrel 1 68\r\n[step9]:setel 1 70\r\n[step10:correction0:SetTail]:setel 1 109 99 89\r\n[step10:correction0:ClearHead]:clrel 1 112 102 92\r\n[step10:correction0:SetHead]:setel 1 112 102 92\r\n[step10:correction0:ClearTail]:clrel 1 109 99 89\r\n[complete]:clra 0\r\n[complete]:clra 1\r\n".Replace("\r", "").Replace("\n", ""); 
        ...
        public void TestCorrect2()
        {
            ...
            // run controller
            Controller controller = new Controller();
            File.Create(@"..\..\..\..\Cases\Case2\recovery_result.txt").Close();
            File.Create(@"..\..\..\..\Cases\Case2\basm_result.txt").Close();

            List<Tuple<List<int>, List<int>>> basmInstructions = controller.InitBasmInstructions(@"..\..\..\..\Cases\Case2\exec_bio_assembly.txt");
            JArray expectedPositions = controller.InitExpectedStatus(@"..\..\..\..\Cases\Case2\expected_position.json");
            // Clear the whole DMF chip
            SerialManager manager = new SerialManager("COM4", 115200);
            controller.Execute(@"..\..\..\..\Cases\Case2\recovery_result.txt", @"..\..\..\..\Cases\Case2\basm_result.txt", basmInstructions, expectedPositions, manager);

            string expectedRecoveryOutput = "List of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   head: [ 326 327 328 ]   tail: [ 422 423 424 ]   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\n".Replace("\r", "").Replace("\n", "");
            string recoveryResult = File.ReadAllText(@"..\..\..\..\Cases\Case2\recovery_result.txt").Replace("\r", "").Replace("\n", "");
            Assert.That(recoveryResult, Is.EqualTo(expectedRecoveryOutput));

            string expectedBasmOutput = "[init]:shv 1 280\r\n[init]:hvpoe 1 1\r\n[init]:clra 0\r\n[init]:clra 1\r\n[step0]:setel 1 65\r\n[step1]:setel 1 66\r\n[step2]:clrel 1 65\r\n[step3]:setel 1 67\r\n[step4]:clrel 1 66\r\n[step5]:setel 1 68\r\n[step6]:clrel 1 67\r\n[step7]:setel 1 69\r\n[step8]:clrel 1 68\r\n[step9]:setel 1 70\r\n[step10:correction0:SetTail]:setel 1 109 99 89\r\n[step10:correction0:ClearHead]:clrel 1 112 102 92\r\n[step10:correction0:SetHead]:setel 1 112 102 92\r\n[step10:correction0:ClearTail]:clrel 1 109 99 89\r\n[complete]:clra 0\r\n[complete]:clra 1\r\n".Replace("\r", "").Replace("\n", "");
            string basmResult = File.ReadAllText(@"..\..\..\..\Cases\Case2\basm_result.txt").Replace("\r", "").Replace("\n", "");
            Assert.That(basmResult, Is.EqualTo(expectedBasmOutput));
        }
        ...
        public void TestCorrect3()
        {
            ...
            // run controller
            Controller controller = new Controller();
            File.Create(@"..\..\..\..\Cases\Case3\recovery_result.txt").Close();
            File.Create(@"..\..\..\..\Cases\Case3\basm_result.txt").Close();

            List<Tuple<List<int>, List<int>>> basmInstructions = controller.InitBasmInstructions(@"..\..\..\..\Cases\Case3\exec_bio_assembly.txt");
            JArray expectedPositions = controller.InitExpectedStatus(@"..\..\..\..\Cases\Case3\expected_position.json");
            // Clear the whole DMF chip
            SerialManager manager = new SerialManager("COM4", 115200);
            controller.Execute(@"..\..\..\..\Cases\Case3\recovery_result.txt", @"..\..\..\..\Cases\Case3\basm_result.txt", basmInstructions, expectedPositions, manager);

            string expectedRecoveryOutput = "List of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   head: [ 326 327 328 ]   tail: [ 422 423 424 ]   ]\r\nList of electrodes need to be manipulated for recovery:\r\n[   ]\r\n".Replace("\r", "").Replace("\n", "");
            string recoveryResult = File.ReadAllText(@"..\..\..\..\Cases\Case3\recovery_result.txt").Replace("\r", "").Replace("\n", "");
            Assert.That(recoveryResult, Is.EqualTo(expectedRecoveryOutput));

            string expectedBasmOutput = "[init]:shv 1 280\r\n[init]:hvpoe 1 1\r\n[init]:clra 0\r\n[init]:clra 1\r\n[step0]:setel 1 65\r\n[step1]:setel 1 66\r\n[step2]:clrel 1 65\r\n[step3]:setel 1 67\r\n[step4]:clrel 1 66\r\n[step5]:setel 1 68\r\n[step6]:clrel 1 67\r\n[step7]:setel 1 69\r\n[step8]:clrel 1 68\r\n[step9]:setel 1 70\r\n[step10:correction0:SetTail]:setel 1 109 99 89\r\n[step10:correction0:ClearHead]:clrel 1 112 102 92\r\n[step10:correction0:SetHead]:setel 1 112 102 92\r\n[step10:correction0:ClearTail]:clrel 1 109 99 89\r\n[complete]:clra 0\r\n[complete]:clra 1\r\n".Replace("\r", "").Replace("\n", "");
            string basmResult = File.ReadAllText(@"..\..\..\..\Cases\Case3\basm_result.txt").Replace("\r", "").Replace("\n", "");
            Assert.That(basmResult, Is.EqualTo(expectedBasmOutput));
        }
    }
}