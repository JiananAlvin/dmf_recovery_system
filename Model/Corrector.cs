...
namespace Model
{
    public class Corrector
    {
        ...
        public List<Dictionary<string, HashSet<int>>> Run(string expectedS, string actualS, string output)
        {
            ...
            List<Dictionary<string, HashSet<int>>> electrodesForRecovery = checker.GetStuckRegion(tolerance, pairs, statesExp, statesAct, init.nonTriangleHashMap, init.triangleHashMap, init.minStep, Initializer.sizeOfSquareEl);
